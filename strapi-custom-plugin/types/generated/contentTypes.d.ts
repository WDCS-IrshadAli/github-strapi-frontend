...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    organization_id: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToOne',
    ...
    modules: Attribute.Relation<
      ...
      'api::module.module'
    >;
    content_management: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiAbcAbc extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date: Attribute.Date;
    date2: Attribute.DateTime;
    boolean2: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiContentManagementContentManagement
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isEnabled: Attribute.Boolean & Attribute.Required;
    content: Attribute.RichText;
    zipcode: Attribute.Integer;
    email: Attribute.Email;
    date: Attribute.Date;
    time: Attribute.Enumeration<['morning', 'evening', 'night', 'afternoon']>;
    organization_id: Attribute.Relation<
      'api::content-management.content-management',
      'manyToOne',
      'api::organization.organization'
...
export interface ApiModuleModule extends Schema.CollectionType {
  ...
  attributes: {
    content: Attribute.Component<'content-management.content-management', true>;
    setting: Attribute.DynamicZone<['content-management.content-management']>;
    dinner: Attribute.DynamicZone<['content-management.content-management']>;
    organization_id: Attribute.Relation<
      'api::module.module',
      'manyToOne',
      'api::organization.organization'
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user_id: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    category: Attribute.Enumeration<['clothes', 'accessories', 'footwear']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date: Attribute.Date;
    type: Attribute.Enumeration<['sale', 'rental']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::content-management.content-management': ApiContentManagementContentManagement;
